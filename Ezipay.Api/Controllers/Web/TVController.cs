...
namespace Ezipay.Api.Controllers
{
    ...
    public class TVController : ApiController
    {
        ...
        public TVController(ITvServices tvServices, ICommonServices commonServices)
        {
        ...
        public async Task<IHttpActionResult> TVServices(RequestModel request)
        {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        if (IsCorrectPassword)
                        {
                            ...
                            {
                                result = await _tvServices.TvService(requestModel);
